...
export default function Index({ suppliers, filters }: Props) {
    ...
    const columns: ColumnDef<Supplier>[] = [
        { key: 'supplier_id', label: 'ID', sortable: true, width: 'w-[10%]' },
        { key: 'supplier_name', label: 'Supplier Name', sortable: true, width: 'w-[20%]' },
        { 
            key: 'contact_number', 
            label: 'Contact Number', 
            sortable: true, 
            width: 'w-[15%]',
            render: (supplier) => supplier.contact_number ?? '—'
        },
        { 
            key: 'contact_person', 
        ...
        { 
            ...
            sortable: true, 
            width: 'w-[15%]',
            render: (supplier) => supplier.email_address ?? '—'
        },
        {
            key: 'status',
            label: 'Status',
            ...
            <div className="p-4 space-y-6 sm:p-6">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">Manage and monitor all suppliers</p>
                    </div>
                </div>
...
Index.layout = {
    breadcrumbs: [
        ...
        { title: 'Supplier Management', href: '/supplier' },
    ],
};