...
export default function Index({ logs, userActions, filters }: Props) {
    ...
    }, [searchQuery, moduleFilter, actionFilter, dateFilter, filters]);
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Review your recent personal actions and updates in the system.
                    </p>
                </div>
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3 text-gray-500 dark:text-gray-400">
                                                {row.target_url ? (
                                                    ...
                                                    <span className="font-bold text-gray-900 underline dark:text-gray-50">{row.description}</span>
                                                )}
                                            </td>
                                        </AnimatedTableRow>
                                    ))
                                    ...
                                    <tr>
                                        <td colSpan={4} className="px-6 py-16 text-center">
                                            <p className="text-base font-medium text-muted-foreground">
                                                {(moduleFilter !== 'All' || actionFilter !== 'All' || dateFilter !== 'All Time' || searchQuery) 
