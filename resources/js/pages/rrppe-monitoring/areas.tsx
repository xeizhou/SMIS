...
export default function Areas({ areas, filters }: Props) {
    ...
    const handleAddSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        addForm.post('/rrppe-monitoring/areas', {
    ...
    const handleEditSubmit = (e: React.FormEvent) => {
        ...
        editForm.put(`/rrppe-monitoring/areas/${selectedArea.id}`, {
    ...
    const handleDelete = () => {
        if (!selectedArea) return;
        router.delete(`/rrppe-monitoring/areas/${selectedArea.id}`, {
            ...
            <div className="p-4 space-y-6 sm:p-6">
                ...
                <div className="relative sticky top-16 group-has-data-[collapsible=icon]/sidebar-wrapper:top-12 transition-[all] ease-linear z-30 -mx-4 -mt-4 mb-6 bg-background/95 backdrop-blur px-4 py-4 sm:-mx-6 sm:-mt-6 sm:px-6 sm:py-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-muted-foreground">
                            Manage the list of areas available for RRPPE Records.
                        </p>
                    </div>
                ...
                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <form onSubmit={handleSearch} className="flex flex-wrap gap-2 flex-1">
                        ...
                        {search && (
                            <Button type="button" variant="ghost" onClick={() => { setSearch(''); router.get('/rrppe-monitoring/areas'); }}>
                                Clear
                            </Button>
                        )}
                    </form>
...
Areas.layout = {
    breadcrumbs: [
        ...
        { title: 'Area Settings', href: '/rrppe-monitoring/areas' },
    ],
};
