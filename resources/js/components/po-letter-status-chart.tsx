        ...
        <div className="rounded-xl border border-sidebar-border/70 bg-white p-4 dark:border-sidebar-border dark:bg-neutral-900">
            ...
            <div className="mt-4 h-64 w-full">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={rows} barGap={6} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                        ...
                        <Legend
                            ...
                            formatter={(value) => (value === 'approved' ? 'Approved' : 'Disapproved')}
                        />
                        <Bar dataKey="approved" fill="#34d399" radius={[4, 4, 0, 0]} maxBarSize={40} />
                        <Bar dataKey="disapproved" fill="#f87171" radius={[4, 4, 0, 0]} maxBarSize={40} />
                    </BarChart>
                </ResponsiveContainer>
            </div>
        </div>
