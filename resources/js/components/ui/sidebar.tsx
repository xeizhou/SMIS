  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div
        ...
        className={cn(
         "group/sidebar-wrapper has-data-[variant=inset]:bg-gradient-to-b has-data-[variant=inset]:from-[#7a0004] has-data-[variant=inset]:via-[#3d0002] has-data-[variant=inset]:to-[#220001] flex h-svh w-full overflow-hidden",
        className
)}
        {...props}
      >
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative isolate flex max-w-full flex-1 flex-col overflow-y-auto overflow-x-hidden min-h-0",
