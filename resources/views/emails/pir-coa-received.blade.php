...
<head>
    ...
    <title>Purchase Order Received by COA</title>
</head>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p style="margin:4px 0 0; color:#ffffff; font-size:20px; font-weight:600;">
                                            Purchase Order Received by COA
                                        </p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 16px; color:#374151; font-size:15px; line-height:1.6;">
                                This is to inform you that Purchase Order No. <strong style="color:#111827;">{{ $poNumber }}</strong>
                                from <strong style="color:#111827;">{{ $supplierName }}</strong> has been officially received by the
                                Commission on Audit (COA).
                            </p>

                            <p style="margin:0 0 24px; color:#374151; font-size:15px; line-height:1.6;">
                                This serves as confirmation that a copy of the Purchase Order has been transmitted to COA for their records.
                            </p>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:4px 0;">
                                                    <span style="display:inline-block; background-color:#dcfce7; color:#166534; font-size:12px; font-weight:600; padding:2px 10px; border-radius:9999px;">
                                                        Received by COA
                                                    </span>
                                                </td>
                                            </tr>
                            ...
                            <p style="margin:0 0 24px; color:#374151; font-size:15px; line-height:1.6;">
                                Should you have any questions or concerns regarding this matter, please contact the
                                Supply Management Unit at <strong style="color:#111827;">(082) 227-8192</strong> local
                                <strong style="color:#111827;">233</strong> or <strong style="color:#111827;">268</strong>.
                            </p>
